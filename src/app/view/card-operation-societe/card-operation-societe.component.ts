...
@Component({
  selector: 'app-card-operation-societe',
  templateUrl: './card-operation-societe.component.html',
  styleUrls: ['./card-operation-societe.component.css']
})
export class CardOperationSocieteComponent implements OnInit {
